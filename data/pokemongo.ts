 ...
 * - bottomtrade: This Pokemon must be traded in a bottom trade
 *
...
export const PokemonGoData: import('../sim/dex-species').PokemonGoDataTable = {
	...
	mewtwo: {
		encounters: ['giovanni', 'raid', 'research', 'bottomtrade'],
	...
	lugia: { encounters: ['giovanni', 'raid', 'research', 'bottomtrade'] },
	hooh: { encounters: ['giovanni', 'raid', 'research', 'bottomtrade'] },
	...
	regirock: { encounters: ['giovanni', 'raid', 'research', 'bottomtrade'] },
	regice: { encounters: ['giovanni', 'raid', 'research', 'bottomtrade'] },
	registeel: { encounters: ['giovanni', 'raid', 'research', 'bottomtrade'] },
	latias: { encounters: ['wild'] },
	latios: { encounters: ['wild'] },
	kyogre: { encounters: ['giovanni', 'raid', 'research', 'bottomtrade'] },
	groudon: { encounters: ['giovanni', 'raid', 'research', 'bottomtrade'] },
	rayquaza: { encounters: ['raid', 'research', 'bottomtrade'] },
	jirachi: { encounters: ['research', 'notrade'] },
	deoxys: { encounters: ['raid', 'bottomtrade'] },
	...
	dialga: { encounters: ['raid', 'bottomtrade'] },
	palkia: { encounters: ['giovanni', 'raid', 'bottomtrade'] },
	heatran: { encounters: ['giovanni', 'raid', 'research', 'bottomtrade'] },
	regigigas: { encounters: ['giovanni', 'raid', 'research', 'bottomtrade'] },
	giratina: { encounters: ['raid', 'bottomtrade'] },
	cresselia: { encounters: ['giovanni', 'raid', 'research', 'bottomtrade'] },
	...
	cobalion: { encounters: ['raid', 'bottomtrade'] }, // research available 2025-02-24
	terrakion: { encounters: ['raid', 'bottomtrade'] }, // research available 2025-02-24
	virizion: { encounters: ['raid', 'bottomtrade'] }, // research available 2025-02-24
	tornadus: { encounters: ['raid', 'research', 'bottomtrade'] }, // research available 2025-02-21
	thundurus: { encounters: ['raid', 'research', 'bottomtrade'] }, // research available 2025-02-21
	reshiram: { encounters: ['raid', 'bottomtrade'] },
	zekrom: { encounters: ['raid', 'bottomtrade'] },
	landorus: { encounters: ['raid', 'research', 'bottomtrade'] }, // research available 2025-02-21
	kyurem: { encounters: ['raid', 'bottomtrade'] },
	// Kyurem-Black/White are not directly obtained from Pokemon GO but should be able to have legal Pokemon GO origin
	kyuremblack: { encounters: ['raid', 'bottomtrade'] },
	kyuremwhite: { encounters: ['raid', 'bottomtrade'] },
	...
	xerneas: { encounters: ['raid', 'bottomtrade'] },
	yveltal: { encounters: ['raid', 'bottomtrade'] },
	...
	cosmog: { encounters: ['research', 'noshiny', 'bottomtrade'] },
	cosmoem: { encounters: ['research', 'noshiny', 'bottomtrade'] },
	solgaleo: { encounters: ['research', 'noshiny', 'bottomtrade'] },
	lunala: { encounters: ['research', 'noshiny', 'bottomtrade'] },
	nihilego: { encounters: ['raid', 'research', 'bottomtrade'] },
	buzzwole: { encounters: ['raid', 'research', 'bottomtrade'] },
	pheromosa: { encounters: ['raid', 'research', 'bottomtrade'] },
	xurkitree: { encounters: ['raid', 'research', 'bottomtrade'] },
	celesteela: { encounters: ['raid', 'research', 'bottomtrade'] },
	kartana: { encounters: ['raid', 'research', 'bottomtrade'] },
	guzzlord: { encounters: ['raid', 'research', 'bottomtrade'] },
	poipole: { encounters: ['research', 'noshiny', 'bottomtrade'] },
	naganadel: { encounters: ['research', 'noshiny', 'bottomtrade'] },
	stakataka: { encounters: ['raid', 'research', 'noshiny', 'bottomtrade'] },
	blacephalon: { encounters: ['raid', 'research', 'noshiny', 'bottomtrade'] },
	necrozma: { encounters: ['raid', 'bottomtrade'] },
	...
	zacian: { encounters: ['raid', 'bottomtrade'] },
	zamazenta: { encounters: ['raid', 'bottomtrade'] },
	zarude: { encounters: ['research', 'noshiny', 'notrade'] },
	regieleki: { encounters: ['raid', 'bottomtrade'] },
	regidrago: { encounters: ['raid', 'bottomtrade'] },
	wyrdeer: { encounters: ['wild'] },
	kleavor: { encounters: ['wild'] },
	ursaluna: { encounters: ['wild'] },
	sneasler: { encounters: ['wild'] },
	overqwil: { encounters: ['wild'] },
	enamorus: { encounters: ['raid', 'noshiny', 'bottomtrade'] },
