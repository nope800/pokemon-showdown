...
export const Learnsets: import('../../../sim/dex-species').ModdedLearnsetDataTable = {
	bulbasaur: {
		...
		eventData: [
			{generation: 7, level: 12, shiny: 1, ivs: {st: 31, toa: 25, tod: 30, boa: 25, bod: 30, hor: 25}, moves: ["leechseed", "vinewhip", "growl", "tackle"], pokeball: "pokeball"},
		],
	},
	ivysaur: {
		learnset: {
	...
	charmander: {
		...
		eventData: [
			{generation: 7, level: 14, shiny: 1, ivs: {st: 25, toa: 30, tod: 25, boa: 30, bod: 25, hor: 31}, moves: ["ember", "smokescreen", "growl", "scratch"], pokeball: "pokeball"},
		],
	},
	charmeleon: {
		learnset: {
	...
	squirtle: {
		...
		eventData: [
			{generation: 7, level: 16, shiny: 1, ivs: {st: 25, toa: 25, tod: 30, boa: 31, bod: 30, hor: 25}, moves: ["withdraw", "bubble", "tailwhip", "tackle"], pokeball: "pokeball"},
		],
	},
	wartortle: {
		learnset: {
	...
	persian: {
		...
		eventData: [
			{generation: 7, level: 16, shiny: 1, ivs: {st: 30, toa: 30, tod: 25, boa: 25, bod: 25, hor: 31}, moves: ["feint", "payday", "taunt", "fakeout"], pokeball: "pokeball"},
		],
	},
	persianalola: {
		learnset: {
	...
	arcanine: {
		...
		eventData: [
			{generation: 7, level: 16, shiny: 1, ivs: {st: 25, toa: 30, tod: 25, boa: 30, bod: 25, hor: 31}, moves: ["roar", "leer", "ember", "doubleedge"], pokeball: "pokeball"},
		],
	},
	poliwag: {
		learnset: {
	...
	hitmonlee: {
		...
		eventData: [
			{generation: 7, level: 30, shiny: 1, ivs: {st: 25, toa: 30, tod: 25, boa: 25, bod: 30, hor: 31}, moves: ["jumpkick", "facade", "brickbreak", "feint"], pokeball: "pokeball"},
		],
	},
	hitmonchan: {
		learnset: {
		...
		eventData: [
			{generation: 7, level: 30, shiny: 1, ivs: {st: 25, toa: 31, tod: 30, boa: 25, bod: 30, hor: 25}, moves: ["firepunch", "icepunch", "thunderpunch", "dizzypunch"], pokeball: "pokeball"},
		],
	},
	lickitung: {
		learnset: {
	...
	magikarp: {
		...
		eventData: [
			{generation: 7, level: 5, shiny: 1, ivs: {st: 30, toa: 31, tod: 25, boa: 25, bod: 25, hor: 31}, moves: ["splash"], pokeball: "pokeball"},
		],
	},
	gyarados: {
		learnset: {
	...
	lapras: {
		...
		eventData: [
			{generation: 7, level: 34, shiny: 1, ivs: {st: 31, toa: 25, tod: 25, boa: 30, bod: 30, hor: 25}, moves: ["bodyslam", "confuseray", "iceshard", "mist"], pokeball: "pokeball"},
		],
	},
	ditto: {
		learnset: {
	...
	porygon: {
		...
		eventData: [
			{generation: 7, level: 34, shiny: 1, ivs: {st: 25, toa: 25, tod: 30, boa: 31, bod: 30, hor: 25}, moves: ["conversion", "thunderwave", "triattack", "barrier"], pokeball: "pokeball"},
		],
	},
	omanyte: {
		learnset: {
