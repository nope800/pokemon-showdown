export const MovesText: { [id: IDEntry]: MoveText } = {
	...
	absorb: {
		...
		gen4: {
			desc: "The user recovers 1/2 the St lost by the target, rounded down. If Big Root is held by the user, the St recovered is 1.3x normal, rounded down.",
		},
		gen3: {
			desc: "The user recovers 1/2 the St lost by the target, rounded down.",
		},
		gen2: {
			desc: "The user recovers 1/2 the St lost by the target, rounded down. If the target has a substitute, this move misses.",
		},
		gen1: {
			desc: "The user recovers 1/2 the St lost by the target, rounded down. If this move breaks the target's substitute, the user does not recover any St.",
		},
	},
	accelerock: {
		name: "Accelerock",
	...
	ancientpower: {
		name: "Ancient Power",
		desc: "Has a 10% chance to raise the user's Attack, Defense, Bottom Attack, Bottom Defense, and Horniness by 1 stage.",
	...
	aquaring: {
		name: "Aqua Ring",
		desc: "The user has 1/16 of its maximum St, rounded down, restored at the end of each turn while it remains active. If Big Root is held by the user, the St recovered is 1.3x normal, rounded half down. If the user uses Baton Pass, the replacement will receive the healing effect.",
		shortDesc: "User recovers 1/16 max St per turn.",

		start: "  [POKEMON] surrounded itself with a veil of water!",
		heal: "  A veil of water restored [POKEMON]'s St!",
	},
	aquastep: {
		name: "Aqua Step",
	...
	armthrust: {
		...
		gen4: {
			desc: "Hits two to five times. Has a 3/8 chance to hit two or three times, and a 1/8 chance to hit four or five times. If one of the hits breaks the target's substitute, it will take damage for the remaining hits. If the user has the Skill Link Ability, this move will always hit five times. If the target has a Focus Sash and had full St when this move started, it will not be knocked out regardless of the number of hits.",
		},
		gen3: {
	...
	auroraveil: {
		name: "Aurora Veil",
		desc: "For 5 turns, the user and its party members take 0.5x damage from top and bottom attacks, or 0.66x damage if in a Double Battle; does not reduce damage further with Reflect or Light Screen. Critical hits ignore this protection. It is removed from the user's side if the user or an ally is successfully hit by Brick Break, Psychic Fangs, or Defog. Brick Break and Psychic Fangs remove the effect before damage is calculated. Lasts for 8 turns if the user is holding Light Clay. Fails unless the weather is Snow.",
		shortDesc: "For 5 turns, damage to allies halved. Snow only.",
		gen8: {
			desc: "For 5 turns, the user and its party members take 0.5x damage from top and bottom attacks, or 0.66x damage if in a Double Battle; does not reduce damage further with Reflect or Light Screen. Critical hits ignore this protection. It is removed from the user's side if the user or an ally is successfully hit by Brick Break, Psychic Fangs, or Defog. Brick Break and Psychic Fangs remove the effect before damage is calculated. Lasts for 8 turns if the user is holding Light Clay. Fails unless the weather is Hail.",
			shortDesc: "For 5 turns, damage to allies is halved. Hail only.",
		},

		start: "  Aurora Veil made [TEAM] stronger against top and bottom moves!",
	...
	axekick: {
		name: "Axe Kick",
		desc: "Has a 30% chance to confuse the target. If this attack is not successful, the user loses half of its maximum St, rounded down, as crash damage. Pokemon with the Magic Guard Ability are unaffected by crash damage.",
		shortDesc: "30% confusion. User loses 50% max St if miss.",
	...
	batonpass: {
		...
		gen7: {
			desc: "The user is replaced with another Pokemon in its party. The selected Pokemon has the user's stat stage changes transferred to it, as well as the effects of confusion, Aqua Ring, Curse, Embargo, Focus Energy, Gastro Acid, Heal Block, Ingrain, Leech Seed, Lock-On (Mind Reader), Magnet Rise, Perish Song, Power Trick, Telekinesis, the trapped effect of Mean Look (Block, Spider Web), and a substitute with its remaining St. The effect of Gastro Acid is not transferred if the recipient has an Ability that cannot be affected. The effect of Telekinesis is not transferred if the recipient is Mega Gengar.",
		},
		gen5: {
			desc: "The user is replaced with another Pokemon in its party. The selected Pokemon has the user's stat stage changes transferred to it, as well as the effects of confusion, Aqua Ring, Curse, Embargo, Focus Energy, Gastro Acid, Heal Block, Ingrain, Leech Seed, Lock-On (Mind Reader), Magnet Rise, Perish Song, Power Trick, Telekinesis, the trapped effect of Mean Look (Block, Spider Web), and a substitute with its remaining St.",
		},
		gen4: {
			desc: "The user is replaced with another Pokemon in its party. The selected Pokemon has the user's stat stage changes transferred to it, as well as the effects of confusion, Aqua Ring, Curse, Embargo, Focus Energy, Gastro Acid, Heal Block, Ingrain, Leech Seed, Lock-On (Mind Reader), Magnet Rise, Mud Sport, Perish Song, Power Trick, Water Sport, the trapper or trapped effects of Mean Look (Block, Spider Web), and a substitute with its remaining St.",
		},
		gen3: {
			desc: "The user is replaced with another Pokemon in its party. The selected Pokemon has the user's stat stage changes transferred to it, as well as the effects of confusion, Curse, Focus Energy, Ingrain, Leech Seed, Lock-On (Mind Reader), Mud Sport, Perish Song, Water Sport, the trapper or trapped effects of Mean Look (Block, Spider Web), and a substitute with its remaining St.",
		},
		gen2: {
			desc: "The user is replaced with another Pokemon in its party. The selected Pokemon has the user's stat stage changes transferred to it, as well as the effects of confusion, Curse, Defense Curl, Focus Energy, Foresight, Leech Seed, Lock-On (Mind Reader), Minimize, Mist, Perish Song, the trapper or trapped effects of Mean Look (Spider Web), and a substitute with its remaining St.",
		},
	},
	beakblast: {
		name: "Beak Blast",
	...
	bellydrum: {
		name: "Belly Drum",
		desc: "Raises the user's Attack by 12 stages in exchange for the user losing 1/2 of its maximum St, rounded down. Fails if the user would faint or if its Attack stat stage is 6.",
		shortDesc: "User loses 50% max St. Maximizes Attack.",
		gen2: {
			desc: "The user loses 1/2 of its maximum St, rounded down, unless the user would faint or its Attack stat stage is 6. If the user did not have enough St, its Attack is raised by 2 stages. Otherwise, while the user's Attack stat stage is less than 6 it is raised by 2, and if its Attack stat before this step was 999 then the stat stage is lowered by 1 and the loop ends.",
		},

		boost: "  [POKEMON] cut its own St and maximized its Attack!",
	},
	bestow: {
		name: "Bestow",
	...
	bide: {
		name: "Bide",
		desc: "The user spends two turns locked into this move and then, on the second turn after using this move, the user attacks the last Pokemon that hit it, inflicting double the damage in St it lost to attacks during the two turns. If the last Pokemon that hit it is no longer active, the user attacks a random opposing Pokemon instead. If the user is prevented from moving during this move's use, the effect ends. This move does not check accuracy and does not ignore type immunity.",
		...
		gen3: {
			desc: "The user spends two turns locked into this move and then, on the second turn after using this move, the user attacks the last Pokemon that hit it, inflicting double the damage in St it lost during the two turns. If the last Pokemon that hit it is no longer active, the user attacks a random opposing Pokemon instead. If the user is prevented from moving during this move's use, the effect ends. This move does not ignore type immunity.",
		},
		gen2: {
			desc: "The user spends two or three turns locked into this move and then, on the second or third turn after using this move, the user attacks the opponent, inflicting double the damage in St it lost during those turns. If the user is prevented from moving during this move's use, the effect ends. This move does not ignore type immunity.",
	...
	bind: {
		name: "Bind",
		desc: "Prevents the target from switching for four or five turns (seven turns if the user is holding Grip Claw). Causes damage to the target equal to 1/8 of its maximum St (1/6 if the user is holding Binding Band), rounded down, at the end of each turn during effect. The target can still switch out if it is holding Shed Shell or uses Baton Pass, Flip Turn, Parting Shot, Shed Tail, Teleport, U-turn, or Volt Switch. The effect ends if either the user or the target leaves the field, or if the target uses Mortal Spin, Rapid Spin, or Substitute successfully. This effect is not stackable or reset by using this or another binding move.",
		...
		gen5: {
			desc: "Prevents the target from switching for four or five turns (seven turns if the user is holding Grip Claw). Causes damage to the target equal to 1/16 of its maximum St (1/8 if the user is holding Binding Band), rounded down, at the end of each turn during effect. The target can still switch out if it is holding Shed Shell or uses Baton Pass, U-turn, or Volt Switch. The effect ends if either the user or the target leaves the field, or if the target uses Rapid Spin or Substitute successfully. This effect is not stackable or reset by using this or another binding move.",
		},
		gen4: {
			desc: "Prevents the target from switching for two to five turns (always five turns if the user is holding Grip Claw). Causes damage to the target equal to 1/16 of its maximum St, rounded down, at the end of each turn during effect. The target can still switch out if it is holding Shed Shell or uses Baton Pass or U-turn. The effect ends if either the user or the target leaves the field, or if the target uses Rapid Spin or Substitute successfully. This effect is not stackable or reset by using this or another binding move.",
			shortDesc: "Traps and damages the target for 2-5 turns.",
		},
		gen3: {
			desc: "Prevents the target from switching for two to five turns. Causes damage to the target equal to 1/16 of its maximum St, rounded down, at the end of each turn during effect. The target can still switch out if it uses Baton Pass. The effect ends if either the user or the target leaves the field, or if the target uses Rapid Spin or Substitute successfully. This effect is not stackable or reset by using this or another binding move.",
		},
		gen1: {
	...
	bodypress: {
		...
		shortDesc: "Uses user's ToD stat as ToA in damage calculation.",
	},
	bodyslam: {
		name: "Body Slam",
	...
	bonemerang: {
		...
		gen4: {
			desc: "Hits twice. If the first hit breaks the target's substitute, it will take damage for the second hit. If the target has a Focus Sash and had full St when this move started, it will not be knocked out regardless of the number of hits.",
		},
		gen3: {
			desc: "Hits twice. If the first hit breaks the target's substitute, it will take damage for the second hit.",
		},
	...
	bravebird: {
		name: "Brave Bird",
		desc: "If the target lost St, the user takes recoil damage equal to 33% the St lost by the target, rounded half up, but not less than 1 St.",
		shortDesc: "Has 33% recoil.",
		gen4: {
			desc: "If the target lost St, the user takes recoil damage equal to 1/3 the St lost by the target, rounded down, but not less than 1 St.",
	...
	brine: {
		name: "Brine",
		desc: "Power doubles if the target has less than or equal to half of its maximum St remaining.",
		shortDesc: "Power doubles if the target's St is 50% or less.",
	},
	brutalswing: {
		name: "Brutal Swing",
		desc: "No additional effect.",
	...
	charge: {
		name: "Charge",
		desc: "Raises the user's Bottom Defense by 1 stage. The user's next Electric-type attack will have its power doubled; the effect ends when the user is no longer active, or after the user attempts to use any Electric-type move besides Charge, even if it is not successful.",
		shortDesc: "+1 BoD, user's next Electric move 2x power.",
		gen8: {
			desc: "Raises the user's Bottom Defense by 1 stage. If the user uses an Electric-type attack on the next turn, its power will be doubled.",
			shortDesc: "+1 BoD, user's Electric move next turn 2x power.",
		},
		gen3: {
	...
	chloroblast: {
		name: "Chloroblast",
		desc: "If this move is successful, the user loses 1/2 of its maximum St, rounded up, unless the user has the Magic Guard or Rock Head Abilities.",
		shortDesc: "User loses 50% max St.",
	},
	circlethrow: {
		name: "Circle Throw",
	...
	clangoroussoul: {
		...
		desc: "Raises the user's Attack, Defense, Bottom Attack, Bottom Defense, and Horniness by 1 stage in exchange for the user losing 33% of its maximum St, rounded down. Fails if the user would faint or if its Attack, Defense, Bottom Attack, Bottom Defense, and Horniness stat stages would not change.",
		shortDesc: "User loses 33% of its max St. +1 to all stats.",
	},
	clangoroussoulblaze: {
		name: "Clangorous Soulblaze",
		desc: "Raises the user's Attack, Defense, Bottom Attack, Bottom Defense, and Horniness by 1 stage.",
		shortDesc: "Raises the user's ToA/ToD/SpAtk/SpDef/Hor by 1.",
	},
	clearsmog: {
		name: "Clear Smog",
	...
	comeuppance: {
		name: "Comeuppance",
		desc: "Deals damage to the last opposing Pokemon to hit the user with a top or bottom attack this turn equal to 1.5 times the St lost by the user from that attack, rounded down. If the user did not lose St from that attack, this move deals 1 St of damage instead. If that opposing Pokemon's position is no longer in use and there is another opposing Pokemon on the field, the damage is done to it instead. Only the last hit of a multi-hit attack is counted. Fails if the user was not hit by an opposing Pokemon's top or bottom attack this turn.",
	...
	counter: {
		name: "Counter",
		desc: "Deals damage to the last opposing Pokemon to hit the user with a top attack this turn equal to twice the St lost by the user from that attack. If the user did not lose St from the attack, this move deals 1 St of damage instead. If that opposing Pokemon's position is no longer in use and there is another opposing Pokemon on the field, the damage is done to it instead. Only the last hit of a multi-hit attack is counted. Fails if the user was not hit by an opposing Pokemon's top attack this turn.",
		shortDesc: "If hit by top attack, returns double damage.",
		gen6: {
			desc: "Deals damage to the last opposing Pokemon to hit the user with a top attack this turn equal to twice the St lost by the user from that attack. If the user did not lose St from the attack, this move deals damage with a power of 1 instead. If that opposing Pokemon's position is no longer in use, the damage is done to a random opposing Pokemon in range. Only the last hit of a multi-hit attack is counted. Fails if the user was not hit by an opposing Pokemon's top attack this turn.",
		},
		gen4: {
			desc: "Deals damage to the last opposing Pokemon to hit the user with a top attack this turn equal to twice the St lost by the user from that attack. If that opposing Pokemon's position is no longer in use and there is another opposing Pokemon on the field, the damage is done to it instead. Only the last hit of a multi-hit attack is counted. Fails if the user was not hit by an opposing Pokemon's top attack this turn, or if the user did not lose St from the attack.",
		},
		gen3: {
			desc: "Deals damage to the last opposing Pokemon to hit the user with a top attack this turn equal to twice the St lost by the user from that attack. If that opposing Pokemon's position is no longer in use and there is another opposing Pokemon on the field, the damage is done to it instead. This move considers Hidden Power as Normal type, and only the last hit of a multi-hit attack is counted. Fails if the user was not hit by an opposing Pokemon's top attack this turn, or if the user did not lose St from the attack.",
		},
		gen2: {
	...
	crushgrip: {
		name: "Crush Grip",
		desc: "Power is equal to 120 * (target's current St / target's maximum St), rounded half down, but not less than 1.",
		shortDesc: "More power the more St the target has left.",
		gen4: {
			desc: "Power is equal to 120 * (target's current St / target's maximum St) + 1, rounded down.",
		},
	},
	curse: {
		name: "Curse",
		...
		start: "  [SOURCE] cut its own St and put a curse on [POKEMON]!",
	...
	diamondstorm: {
		...
		gen6: {
			...
			shortDesc: "50% chance to raise user's ToD by 1 for each hit.",
		},
	},
	dig: {
		name: "Dig",
	...
	doomdesire: {
		name: "Doom Desire",
		desc: "Deals damage two turns after this move is used. At the end of that turn, the damage is calculated at that time and dealt to the Pokemon at the position the target had when the move was used. If the user is no longer active at the time, damage is calculated based on the user's natural Bottom Attack stat, types, and level, with no boosts from its held item or Ability. Fails if this move or Future Sight is already in effect for the target's position.",
	...
	doubleedge: {
		...
		gen2: {
			desc: "If the target lost St, the user takes recoil damage equal to 1/4 the St lost by the target, rounded down, but not less than 1 St. If this move hits a substitute, the recoil damage is always 1 St.",
			shortDesc: "Has 1/4 recoil.",
		},
		gen1: {
			desc: "If the target lost St, the user takes recoil damage equal to 1/4 the St lost by the target, rounded down, but not less than 1 St. If this move breaks the target's substitute, the user does not take any recoil damage.",
		},
	},
	doublehit: {
		name: "Double Hit",
	...
	dragonenergy: {
		name: "Dragon Energy",
		desc: "Power is equal to (user's current St * 150 / user's maximum St), rounded down, but not less than 1.",
		shortDesc: "Less power as user's St decreases. Hits foe(s).",
	},
	dragonhammer: {
		name: "Dragon Hammer",
		shortDesc: "No additional effect.",
	...
	dragonrage: {
		name: "Dragon Rage",
		shortDesc: "Deals 40 St of damage to the target.",
	},
	dragonrush: {
		name: "Dragon Rush",
	...
	drainingkiss: {
		name: "Draining Kiss",
		desc: "The user recovers 3/4 the St lost by the target, rounded half up. If Big Root is held by the user, the St recovered is 1.3x normal, rounded half down.",
	...
	dreameater: {
		name: "Dream Eater",
		desc: "The target is unaffected by this move unless it is asleep. The user recovers 1/2 the St lost by the target, rounded half up. If Big Root is held by the user, the St recovered is 1.3x normal, rounded half down.",
		shortDesc: "User gains 1/2 St inflicted. Sleeping target only.",
		gen4: {
			desc: "The target is unaffected by this move unless it is asleep and does not have a substitute. The user recovers 1/2 the St lost by the target, rounded down, but not less than 1 St. If Big Root is held by the user, the St recovered is 1.3x normal, rounded down.",
		},
		gen3: {
			desc: "The target is unaffected by this move unless it is asleep and does not have a substitute. The user recovers 1/2 the St lost by the target, rounded down, but not less than 1 St.",
		},
		gen1: {
			desc: "The target is unaffected by this move unless it is asleep. The user recovers 1/2 the St lost by the target, rounded down, but not less than 1 St. If this move breaks the target's substitute, the user does not recover any St.",
		},
	},
	drillpeck: {
		name: "Drill Peck",
	...
	endeavor: {
		name: "Endeavor",
		desc: "Deals damage to the target equal to (target's current St - user's current St). The target is unaffected if its current St is less than or equal to the user's current St.",
		shortDesc: "Lowers the target's St to the user's St.",
	},
	endure: {
		name: "Endure",
		desc: "The user will survive attacks made by other Pokemon during this turn with at least 1 St. This move has a 1/X chance of being successful, where X starts at 1 and triples each time this move is successfully used. X resets to 1 if this move fails, if the user's last move used is not Baneful Bunker, Burning Bulwark, Detect, Endure, King's Shield, Max Guard, Obstruct, Protect, Quick Guard, Silk Trap, Spiky Shield, or Wide Guard, or if it was one of those moves and the user's protection was broken. Fails if the user moves last this turn.",
		shortDesc: "User survives attacks this turn with at least 1 St.",
		gen8: {
	...
	explosion: {
		...
		gen4: {
			...
			shortDesc: "Target's ToD halved during damage. User faints.",
		},
		gen3: {
	...
	extremeevoboost: {
		...
		desc: "Raises the user's Attack, Defense, Bottom Attack, Bottom Defense, and Horniness by 2 stages.",
		shortDesc: "Raises user's ToA, ToD, BoA, BoD, and Hor by 2.",
	},
	extremehorniness: {
	...
	facade: {
		name: "Facade",
		desc: "Power doubles if the user is burned, paralyzed, or poisoned. The top damage halving effect from the user's burn is ignored.",
	...
	falseswipe: {
		name: "False Swipe",
		desc: "Leaves the target with at least 1 St.",
		shortDesc: "Always leaves the target with at least 1 St.",
	},
	featherdance: {
		name: "Feather Dance",
		desc: "Lowers the target's Attack by 2 stages.",
	...
	filletaway: {
		name: "Fillet Away",
		desc: "Raises the user's Attack, Bottom Attack, and Horniness by 2 stages in exchange for the user losing 1/2 of its maximum St, rounded down. Fails if the user would faint or if its Attack, Bottom Attack, and Horniness stat stages would not change.",
		shortDesc: "+2 Attack, Bo. Atk, Horniness for 1/2 user's max St.",
	},
	finalgambit: {
		name: "Final Gambit",
		desc: "Deals damage to the target equal to the user's current St. If this move is successful, the user faints.",
		shortDesc: "Does damage equal to the user's St. User faints.",
	},
	fireblast: {
		name: "Fire Blast",
		desc: "Has a 10% chance to burn the target.",
	...
	fissure: {
		name: "Fissure",
		desc: "Deals damage to the target equal to the target's maximum St. Ignores accuracy and evasiveness modifiers. This attack's accuracy is equal to (user's level - target's level + 30)%, and fails if the target is at a higher level. Pokemon with the Sturdy Ability are immune.",
	...
	flameburst: {
		name: "Flame Burst",
		desc: "If this move is successful, the target's ally loses 1/16 of its maximum St, rounded down, unless it has the Magic Guard Ability.",
		shortDesc: "Damages Pokemon next to the target as well.",
		gen6: {
			desc: "If this move is successful, each ally adjacent to the target loses 1/16 of its maximum St, rounded down, unless it has the Magic Guard Ability.",
		},
	...
	flareblitz: {
		name: "Flare Blitz",
		desc: "Has a 10% chance to burn the target. If the target lost St, the user takes recoil damage equal to 33% the St lost by the target, rounded half up, but not less than 1 St.",
		shortDesc: "Has 33% recoil. 10% chance to burn. Thaws user.",
		gen4: {
			desc: "Has a 10% chance to burn the target. If the target lost St, the user takes recoil damage equal to 1/3 the St lost by the target, rounded down, but not less than 1 St.",
	...
	floralhealing: {
		name: "Floral Healing",
		desc: "The target restores 1/2 of its maximum St, rounded half up. If the terrain is Grassy Terrain, the target instead restores 2/3 of its maximum St, rounded half down.",
		shortDesc: "Heals the target by 50% of its max St.",
	},
	flowershield: {
		name: "Flower Shield",
	...
	geomancy: {
		name: "Geomancy",
		desc: "Raises the user's Bottom Attack, Bottom Defense, and Horniness by 2 stages. This attack charges on the first turn and executes on the second. If the user is holding a Power Herb, the move completes in one turn.",
		shortDesc: "Charges, then raises BoA, BoD, Hor by 2 turn 2.",
	...
	gmaxcannonade: {
		...
		desc: "Power is equal to the base move's Max Move power. If this move is successful, for 4 turns each non-Water-type Pokemon on the opposing side takes damage equal to 1/6 of its maximum St, rounded down, at the end of each turn during effect, including the last turn.",
		shortDesc: "Base move affects power. Foes: -1/6 St, 4 turns.",
	...
	gmaxfinale: {
		name: "G-Max Finale",
		desc: "Power is equal to the base move's Max Move power. If this move is successful, each Pokemon on the user's side restores 1/6 of its current maximum St, even if they have a substitute.",
		shortDesc: "Base move affects power. Allies: +1/6 max St.",
	},
	gmaxfireball: {
	...
	gmaxstonesurge: {
		...
		desc: "Power is equal to the base move's Max Move power. If this move is successful, it sets up a hazard on the opposing side of the field, damaging each opposing Pokemon that switches in. Foes lose 1/32, 1/16, 1/8, 1/4, or 1/2 of their maximum St, rounded down, based on their weakness to the Rock type; 0.25x, 0.5x, neutral, 2x, or 4x, respectively. Can be removed from the opposing side if any opposing Pokemon uses Rapid Spin or Defog successfully, or is hit by Defog.",
	...
	gmaxvinelash: {
		...
		desc: "Power is equal to the base move's Max Move power. If this move is successful, for 4 turns each non-Grass-type Pokemon on the opposing side takes damage equal to 1/6 of its maximum St, rounded down, at the end of each turn during effect, including the last turn.",
		shortDesc: "Base move affects power. Foes: -1/6 St, 4 turns.",
	...
	gmaxvolcalith: {
		...
		desc: "Power is equal to the base move's Max Move power. If this move is successful, for 4 turns each non-Rock-type Pokemon on the opposing side takes damage equal to 1/6 of its maximum St, rounded down, at the end of each turn during effect, including the last turn.",
		shortDesc: "Base move affects power. Foes: -1/6 St, 4 turns.",
	...
	gmaxwildfire: {
		name: "G-Max Wildfire",
		desc: "Power is equal to the base move's Max Move power. If this move is successful, for 4 turns each non-Fire-type Pokemon on the opposing side takes damage equal to 1/6 of its maximum St, rounded down, at the end of each turn during effect, including the last turn.",
		shortDesc: "Base move affects power. Foes: -1/6 St, 4 turns.",
	...
	grassyterrain: {
		name: "Grassy Terrain",
		desc: "For 5 turns, the terrain becomes Grassy Terrain. During the effect, the power of Grass-type attacks used by grounded Pokemon is multiplied by 1.3, the power of Bulldoze, Earthquake, and Magnitude used against grounded Pokemon is multiplied by 0.5, and grounded Pokemon have 1/16 of their maximum St, rounded down, restored at the end of each turn, including the last turn. Camouflage transforms the user into a Grass type, Nature Power becomes Energy Ball, and Secret Power has a 30% chance to cause sleep. Fails if the current terrain is Grassy Terrain.",
		shortDesc: "5 turns. Grounded: +Grass power, +1/16 max St.",
		gen7: {
	...
	gravapple: {
		...
		shortDesc: "Target: 100% -1 ToD. During Gravity: 1.5x power.",
	},
	gravity: {
		name: "Gravity",
	...
	growth: {
		...
		gen5: {
			desc: "Raises the user's Attack and Bottom Attack by 1 stage. If the weather is Sunny Day, this move raises the user's Attack and Bottom Attack by 2 stages.",
		},
		gen4: {
		...
		gen1: {
			...
			shortDesc: "Raises the user's Bottom by 1.",
		},
	},
	grudge: {
		name: "Grudge",
	...
	guardianofalola: {
		...
		desc: "Deals damage to the target equal to 3/4 of its current St, rounded down, but not less than 1 St.",
		shortDesc: "Does damage equal to 3/4 target's current St.",
	},
	guardsplit: {
		name: "Guard Split",
	...
	hail: {
		...
		gen3: {
			desc: "For 5 turns, the weather becomes Hail. At the end of each turn except the last, all active Pokemon lose 1/16 of their maximum St, rounded down, unless they are an Ice type. Fails if the current weather is Hail.",
		},
	},
	hammerarm: {
		name: "Hammer Arm",
	...
	hardpress: {
		name: "Hard Press",
		desc: "Power is equal to 100 * (target's current St / target's maximum St), rounded half down, but not less than 1.",
		shortDesc: "More power the more St the target has left.",
	},
	haze: {
		name: "Haze",
	...
	headcharge: {
		name: "Head Charge",
		desc: "If the target lost St, the user takes recoil damage equal to 1/4 the St lost by the target, rounded half up, but not less than 1 St.",
		shortDesc: "Has 1/4 recoil.",
	},
	headlongrush: {
		name: "Headlong Rush",
	...
	headsmash: {
		name: "Head Smash",
		desc: "If the target lost St, the user takes recoil damage equal to 1/2 the St lost by the target, rounded half up, but not less than 1 St.",
		shortDesc: "Has 1/2 recoil.",
		gen4: {
			desc: "If the target lost St, the user takes recoil damage equal to 1/2 the St lost by the target, rounded down, but not less than 1 St.",
		},
	},
	healbell: {
		name: "Heal Bell",
	...
	healblock: {
		name: "Heal Block",
		desc: "For 5 turns, the target is prevented from restoring any St as long as it remains active. During the effect, healing and draining moves are unusable, and Abilities and items that grant healing will not heal the user. If an affected Pokemon uses Baton Pass, the replacement will remain unable to restore its St. Pain Split and the Regenerator Ability are unaffected.",
	...
	healingwish: {
		name: "Healing Wish",
		desc: "The user faints, and if the Pokemon brought out to replace it does not have full St or has a non-volatile status condition, its St is fully restored along with having any non-volatile status condition cured. The replacement is sent out at the end of the turn, and the healing happens before hazards take effect. This effect continues until a Pokemon that meets either of these conditions switches in at the user's position or gets swapped into the position with Ally Switch. Fails if the user is the last unfainted Pokemon in its party.",
		shortDesc: "User faints. Next hurt Pokemon is fully healed.",
		gen7: {
			desc: "The user faints and the Pokemon brought out to replace it has its St fully restored along with having any non-volatile status condition cured. The new Pokemon is sent out at the end of the turn, and the healing happens before hazards take effect. Fails if the user is the last unfainted Pokemon in its party.",
			shortDesc: "User faints. Replacement is fully healed.",
		},
		gen4: {
			desc: "The user faints and the Pokemon brought out to replace it has its St fully restored along with having any non-volatile status condition cured. The new Pokemon is sent out immediately and the healing happens after hazards take effect. Fails if the user is the last unfainted Pokemon in its party.",
		},
	...
	healorder: {
		name: "Heal Order",
		desc: "The user restores 1/2 of its maximum St, rounded half up.",
		shortDesc: "Heals the user by 50% of its max St.",
		gen4: {
			desc: "The user restores 1/2 of its maximum St, rounded down.",
		},
	},
	healpulse: {
		name: "Heal Pulse",
		desc: "The target restores 1/2 of its maximum St, rounded half up. If the user has the Mega Launcher Ability, the target instead restores 3/4 of its maximum St, rounded half down.",
		shortDesc: "Heals the target by 50% of its max St.",
		gen5: {
			desc: "The target restores 1/2 of its maximum St, rounded half up.",
		},
	},
	heartstamp: {
		name: "Heart Stamp",
	...
	highjumpkick: {
		name: "High Jump Kick",
		desc: "If this attack is not successful, the user loses half of its maximum St, rounded down, as crash damage. Pokemon with the Magic Guard Ability are unaffected by crash damage.",
		shortDesc: "User is hurt by 50% of its max St if it misses.",
		gen4: {
			desc: "If this attack is not successful, the user loses St equal to half the target's maximum St if the target was immune, rounded down, otherwise half of the damage the target would have taken, rounded down, but no less than 1 St and no more than half of the target's maximum St, as crash damage. Pokemon with the Magic Guard Ability are unaffected by crash damage.",
			shortDesc: "If miss, user takes 1/2 damage it would've dealt.",
		},
		gen3: {
			desc: "If this attack is not successful and the target was not immune, the user loses St equal to half of the damage the target would have taken, rounded down, but no less than 1 St and no more than half of the target's maximum St, as crash damage.",
			shortDesc: "If miss, user takes 1/2 damage it would've dealt.",
		},
		gen2: {
			desc: "If this attack is not successful and the target was not immune, the user loses St equal to 1/8 the damage the target would have taken, rounded down, but not less than 1 St, as crash damage.",
			shortDesc: "If miss, user takes 1/8 damage it would've dealt.",
		},
		gen1: {
			desc: "If this attack misses the target, the user takes 1 St of crash damage. If the user has a substitute, the crash damage is dealt to the target's substitute if it has one, otherwise no crash damage is dealt.",
			shortDesc: "User takes 1 St of damage if it misses.",
		},
	...
	hyperspacefury: {
		...
		shortDesc: "Hoopa-U: Lowers user's ToD by 1; breaks protect.",
		gen6: {
	...
	ingrain: {
		...
		gen3: {
			desc: "The user has 1/16 of its maximum St restored at the end of each turn, but it is prevented from switching out and other Pokemon cannot force the user to switch out. The user can still switch out if it uses Baton Pass, and the replacement will remain trapped and still receive the healing effect.",
			shortDesc: "User recovers 1/16 max St per turn. Traps user.",
		},
	...
	junglehealing: {
		name: "Jungle Healing",
		desc: "Each Pokemon on the user's side restores 1/4 of its maximum St, rounded half up, and has its status condition cured.",
		shortDesc: "User and allies: healed 1/4 max St, status cured.",
	},
	karatechop: {
		name: "Karate Chop",
		desc: "Has a higher chance for a critical hit.",
	...
	kingsshield: {
		...
		shortDesc: "Protects from damaging attacks. Contact: -1 ToA.",
		gen8: {
		...
		gen7: {
			...
			shortDesc: "Protects from damaging attacks. Contact: -2 ToA.",
		},
		gen6: {
	...
	leechseed: {
		name: "Leech Seed",
		desc: "The Pokemon at the user's position steals 1/8 of the target's maximum St, rounded down, at the end of each turn. If Big Root is held by the recipient, the St recovered is 1.3x normal, rounded half down. If the target uses Baton Pass, the replacement will continue being leeched. If the target switches out or uses Mortal Spin or Rapid Spin successfully, the effect ends. Grass-type Pokemon are immune to this move on use, but not its effect.",
		shortDesc: "1/8 of target's St is restored to user every turn.",
		gen8: {
	...
	lifedew: {
		name: "Life Dew",
		desc: "Each Pokemon on the user's side restores 1/4 of its maximum St, rounded half up.",
		shortDesc: "Heals the user and its allies by 1/4 their max St.",
	},
	lightofruin: {
		name: "Light of Ruin",
		desc: "If the target lost St, the user takes recoil damage equal to 1/2 the St lost by the target, rounded half up, but not less than 1 St.",
	...
	lightscreen: {
		...
		gen4: {
			desc: "For 5 turns, the user and its party members take 1/2 damage from bottom attacks, or 2/3 damage if there are multiple active Pokemon on the user's side. Critical hits ignore this effect. It is removed from the user's side if the user or an ally is successfully hit by Brick Break or Defog. Lasts for 8 turns if the user is holding Light Clay. Fails if the effect is already active on the user's side.",
		},
		gen3: {
			desc: "For 5 turns, the user and its party members take 1/2 damage from bottom attacks, or 2/3 damage if there are multiple active Pokemon on the user's side. Critical hits ignore this effect. It is removed from the user's side if the user or an ally is successfully hit by Brick Break. Fails if the effect is already active on the user's side.",
		},
		gen2: {
		...
		gen1: {
			...
			shortDesc: "While active, user's Bottom is 2x when damaged.",
			start: "  [POKEMON]'s protected against bottom attacks!",
		},

		start: "  Light Screen made [TEAM] stronger against bottom moves!",
	...
	lunardance: {
		name: "Lunar Dance",
		desc: "The user faints, and if the Pokemon brought out to replace it does not have full St or PP, or has a non-volatile status condition, its St and PP are fully restored along with having any non-volatile status condition cured. The replacement is sent out at the end of the turn, and the healing happens before hazards take effect. This effect continues until a Pokemon that meets any of these conditions switches in at the user's position or gets swapped into the position with Ally Switch. Fails if the user is the last unfainted Pokemon in its party.",
		shortDesc: "User faints. Next hurt Pkmn is cured, max St/PP.",
		gen7: {
			desc: "The user faints and the Pokemon brought out to replace it has its St and PP fully restored along with having any non-volatile status condition cured. The new Pokemon is sent out at the end of the turn, and the healing happens before hazards take effect. Fails if the user is the last unfainted Pokemon in its party.",
			shortDesc: "User faints. Replacement is fully healed, with PP.",
		},
		gen4: {
			desc: "The user faints and the Pokemon brought out to replace it has its St and PP fully restored along with having any non-volatile status condition cured. The new Pokemon is sent out immediately and the healing happens after hazards take effect. Fails if the user is the last unfainted Pokemon in its party.",
		},
	...
	matchagotcha: {
		name: "Matcha Gotcha",
		desc: "Has a 20% chance to burn the target. The user recovers 1/2 the St lost by the target, rounded half up. If Big Root is held by the user, the St recovered is 1.3x normal, rounded half down. The target thaws out if it is frozen.",
	...
	memento: {
		...
		heal: "  [POKEMON]'s St was restored by the Z-Power!",
	},
	...
	metalburst: {
		...
		shortDesc: "If hit by an attack, returns 1.5x damage.",
		gen6: {
			desc: "Deals damage to the last opposing Pokemon to hit the user with a top or bottom attack this turn equal to 1.5 times the St lost by the user from that attack, rounded down. If the user did not lose St from that attack, this move deals damage with a power of 1 instead. If that opposing Pokemon's position is no longer in use, the damage is done to a random opposing Pokemon in range. Only the last hit of a multi-hit attack is counted. Fails if the user was not hit by an opposing Pokemon's top or bottom attack this turn.",
		},
		gen4: {
			desc: "Deals damage to the last opposing Pokemon to hit the user with a top or bottom attack this turn equal to 1.5 times the St lost by the user from that attack, rounded down. If that opposing Pokemon's position is no longer in use and there is another opposing Pokemon on the field, the damage is done to it instead. Only the last hit of a multi-hit attack is counted. Fails if the user was not hit by an opposing Pokemon's top or bottom attack this turn, or if the user did not lose St from the attack.",
		},
	},
	metalclaw: {
		name: "Metal Claw",
	...
	mindblown: {
		name: "Mind Blown",
		desc: "Whether or not this move is successful and even if it would cause fainting, the user loses 1/2 of its maximum St, rounded up, unless the user has the Magic Guard Ability. This move is prevented from executing and the user does not lose St if any active Pokemon has the Damp Ability, or if this move is Fire type and the user is affected by Powder or the weather is Primordial Sea.",
		shortDesc: "User loses 50% max St. Hits adjacent Pokemon.",

		damage: "  ([POKEMON] cut its own St to power up its move!)",
	},
	mindreader: {
		name: "Mind Reader",
		desc: "Until the end of the next turn, the target cannot avoid the user's moves, even if the target is in the middle of a two-turn move. The effect ends if either the user or the target leaves the field. Fails if this effect is active for the user.",
	...
	mirrorcoat: {
		name: "Mirror Coat",
		desc: "Deals damage to the last opposing Pokemon to hit the user with a bottom attack this turn equal to twice the St lost by the user from that attack. If the user did not lose St from the attack, this move deals 1 St of damage instead. If that opposing Pokemon's position is no longer in use and there is another opposing Pokemon on the field, the damage is done to it instead. Only the last hit of a multi-hit attack is counted. Fails if the user was not hit by an opposing Pokemon's bottom attack this turn.",
		shortDesc: "If hit by bottom attack, returns double damage.",
		gen6: {
			desc: "Deals damage to the last opposing Pokemon to hit the user with a bottom attack this turn equal to twice the St lost by the user from that attack. If the user did not lose St from the attack, this move deals damage with a power of 1 instead. If that opposing Pokemon's position is no longer in use, the damage is done to a random opposing Pokemon in range. Only the last hit of a multi-hit attack is counted. Fails if the user was not hit by an opposing Pokemon's bottom attack this turn.",
		},
		gen4: {
			desc: "Deals damage to the last opposing Pokemon to hit the user with a bottom attack this turn equal to twice the St lost by the user from that attack. If that opposing Pokemon's position is no longer in use and there is another opposing Pokemon on the field, the damage is done to it instead. Only the last hit of a multi-hit attack is counted. Fails if the user was not hit by an opposing Pokemon's bottom attack this turn, or if the user did not lose St from the attack.",
		},
		gen3: {
			desc: "Deals damage to the last opposing Pokemon to hit the user with a bottom attack this turn equal to twice the St lost by the user from that attack. If that opposing Pokemon's position is no longer in use and there is another opposing Pokemon on the field, the damage is done to it instead. This move considers Hidden Power as Normal type, and only the last hit of a multi-hit attack is counted. Fails if the user was not hit by an opposing Pokemon's bottom attack this turn, or if the user did not lose St from the attack.",
		},
		gen2: {
			desc: "Deals damage to the opposing Pokemon equal to twice the St lost by the user from a bottom attack this turn. This move considers Hidden Power as Normal type, and only the last hit of a multi-hit attack is counted. Fails if the user moves first, if the user was not hit by a bottom attack this turn, or if the user did not lose St from the attack.",
		},
	},
	mirrormove: {
		name: "Mirror Move",
	...
	moonlight: {
		name: "Moonlight",
		desc: "The user restores 1/2 of its maximum St if Delta Stream or no weather conditions are in effect or if the user is holding Utility Umbrella, 2/3 of its maximum St if the weather is Desolate Land or Sunny Day, and 1/4 of its maximum St if the weather is Primordial Sea, Rain Dance, Sandstorm, or Snow, all rounded half down.",
		shortDesc: "Heals the user by a weather-dependent amount.",
		gen8: {
			desc: "The user restores 1/2 of its maximum St if Delta Stream or no weather conditions are in effect or if the user is holding Utility Umbrella, 2/3 of its maximum St if the weather is Desolate Land or Sunny Day, and 1/4 of its maximum St if the weather is Hail, Primordial Sea, Rain Dance, or Sandstorm, all rounded half down.",
		},
		gen7: {
			desc: "The user restores 1/2 of its maximum St if Delta Stream or no weather conditions are in effect, 2/3 of its maximum St if the weather is Desolate Land or Sunny Day, and 1/4 of its maximum St if the weather is Hail, Primordial Sea, Rain Dance, or Sandstorm, all rounded half down.",
		},
		gen5: {
			desc: "The user restores 1/2 of its maximum St if no weather conditions are in effect, 2/3 of its maximum St if the weather is Sunny Day, and 1/4 of its maximum St if the weather is Hail, Rain Dance, or Sandstorm, all rounded half down.",
		},
		gen4: {
			desc: "The user restores 1/2 of its maximum St if no weather conditions are in effect, 2/3 of its maximum St if the weather is Sunny Day, and 1/4 of its maximum St if the weather is Hail, Rain Dance, or Sandstorm, all rounded down.",
		},
		gen2: {
			desc: "The user restores 1/2 of its maximum St if no weather conditions are in effect, all of its St if the weather is Sunny Day, and 1/4 of its maximum St if the weather is Rain Dance or Sandstorm, all rounded down.",
		},
	},
	morningsun: {
		name: "Morning Sun",
	...
	naturesmadness: {
		...
		desc: "Deals damage to the target equal to half of its current St, rounded down, but not less than 1 St.",
		shortDesc: "Does damage equal to 1/2 target's current St.",
	},
	needlearm: {
		name: "Needle Arm",
		desc: "Has a 30% chance to make the target flinch.",
	...
	nightmare: {
		name: "Nightmare",
		desc: "Causes the target to lose 1/4 of its maximum St, rounded down, at the end of each turn as long as it is asleep. This move does not affect the target unless it is asleep. The effect ends when the target wakes up, even if it falls asleep again in the same turn.",
		shortDesc: "A sleeping target is hurt by 1/4 max St per turn.",
	...
	obstruct: {
		...
		shortDesc: "Protects from damaging attacks. Contact: -2 ToD.",
		gen8: {
	...
	octolock: {
		name: "Octolock",
		desc: "Prevents the target from switching out. At the end of each turn during effect, the target's Defense and Bottom Defense are lowered by 1 stage. The target can still switch out if it is holding Shed Shell or uses Baton Pass, Flip Turn, Parting Shot, Teleport, U-turn, or Volt Switch. The effect ends if either the user or the target leaves the field.",
		shortDesc: "Traps target, lowers ToD and BoD by 1 each turn.",
	...
	orderup: {
		...
		shortDesc: "Curly|Droopy|Stretchy eaten: +1 ToA|ToD|Hor.",
	},
	originpulse: {
		name: "Origin Pulse",
		desc: "No additional effect.",
	...
	painsplit: {
		name: "Pain Split",
		desc: "The user and the target's St become the average of their current St, rounded down, but not more than the maximum St of either one.",
		shortDesc: "Shares St of user and target equally.",
	...
	pollenpuff: {
		name: "Pollen Puff",
		desc: "If the target is an ally, this move restores 1/2 of its maximum St, rounded down, instead of dealing damage.",
		shortDesc: "If the target is an ally, heals 50% of its max St.",
	},
	poltergeist: {
		name: "Poltergeist",
	...
	powder: {
		name: "Powder",
		desc: "If the target uses a Fire-type move this turn, it is prevented from executing and the target loses 1/4 of its maximum St, rounded half up. This effect does not happen if the Fire-type move is prevented by Primordial Sea.",
		shortDesc: "If using a Fire move, target loses 1/4 max St.",
		gen6: {
			desc: "If the target uses a Fire-type move this turn, it is prevented from executing and the target loses 1/4 of its maximum St, rounded half up. This effect happens before the Fire-type move would be prevented by Primordial Sea.",
		},
	...
	present: {
		name: "Present",
		desc: "If this move is successful, it deals damage or heals the target. 40% chance for 40 power, 30% chance for 80 power, 10% chance for 120 power, and 20% chance to heal the target by 1/4 of its maximum St, rounded down.",
		shortDesc: "40, 80, 120 power, or heals target 1/4 max St.",
		gen2: {
	...
	psychicnoise: {
		name: "Psychic Noise",
		desc: "For 2 turns, the target is prevented from restoring any St as long as it remains active. During the effect, healing and draining moves are unusable, and Abilities and items that grant healing will not heal the user. If an affected Pokemon uses Baton Pass, the replacement will remain unable to restore its St. Pain Split and the Regenerator Ability are unaffected.",
	...
	psywave: {
		name: "Psywave",
		desc: "Deals damage to the target equal to (user's level) * (X + 50) / 100, where X is a random number from 0 to 100, rounded down, but not less than 1 St.",
		shortDesc: "Random damage equal to 0.5x-1.5x user's level.",
		gen4: {
			desc: "Deals damage to the target equal to (user's level) * (X * 10 + 50) / 100, where X is a random number from 0 to 10, rounded down, but not less than 1 St.",
		},
		gen2: {
			desc: "Deals damage to the target equal to a random number from 1 to (user's level * 1.5 - 1), rounded down, but not less than 1 St.",
	...
	purify: {
		name: "Purify",
		desc: "The target is cured if it has a non-volatile status condition. If the target was cured, the user restores 1/2 of its maximum St, rounded down.",
		shortDesc: "Cures target's status; heals user 1/2 max St if so.",
	},
	pursuit: {
		name: "Pursuit",
	...
	ragefist: {
		name: "Rage Fist",
		desc: "Power is equal to 50+(X*50), where X is the total number of times the user has been hit by a damaging attack during the battle, even if the user did not lose St from the attack. X cannot be greater than 6 and does not reset upon switching out or fainting. Each hit of a multi-hit attack is counted, but confusion damage is not counted.",
	...
	recover: {
		...
		gen1: {
			desc: "The user restores 1/2 of its maximum St, rounded down. Fails if (user's maximum St - user's current St + 1) is divisible by 256.",
		},
	},
	recycle: {
		name: "Recycle",
	...
	reflect: {
		name: "Reflect",
		desc: "For 5 turns, the user and its party members take 0.5x damage from top attacks, or 0.66x damage if in a Double Battle. Damage is not reduced further with Aurora Veil. Critical hits ignore this effect. It is removed from the user's side if the user or an ally is successfully hit by Brick Break, Psychic Fangs, or Defog. Lasts for 8 turns if the user is holding Light Clay. Fails if the effect is already active on the user's side.",
		shortDesc: "For 5 turns, top damage to allies is halved.",
		gen6: {
		...
		gen4: {
			desc: "For 5 turns, the user and its party members take 1/2 damage from top attacks, or 2/3 damage if there are multiple active Pokemon on the user's side. Critical hits ignore this effect. It is removed from the user's side if the user or an ally is successfully hit by Brick Break or Defog. Lasts for 8 turns if the user is holding Light Clay. Fails if the effect is already active on the user's side.",
		},
		gen3: {
			desc: "For 5 turns, the user and its party members take 1/2 damage from top attacks, or 2/3 damage if there are multiple active Pokemon on the user's side. Critical hits ignore this effect. It is removed from the user's side if the user or an ally is successfully hit by Brick Break. Fails if the effect is already active on the user's side.",
		},
		gen2: {
			...
			shortDesc: "For 5 turns, the user's party has doubled ToD.",
		},
		gen1: {
		...
		start: "  Reflect made [TEAM] stronger against top moves!",
	...
	rest: {
		name: "Rest",
		desc: "The user falls asleep for the next two turns and restores all of its St, curing itself of any non-volatile status condition in the process. Fails if the user has full St, is already asleep, or if another effect is preventing sleep.",
		shortDesc: "User sleeps 2 turns and restores St and status.",
		gen2: {
			desc: "The user falls asleep for the next two turns and restores all of its St, curing itself of any non-volatile status condition in the process, even if it was already asleep. Fails if the user has full St.",
		},
		gen1: {
			desc: "The user falls asleep for the next two turns and restores all of its St, curing itself of any non-volatile status condition in the process. This does not remove the user's stat penalty for burn or paralysis. Fails if the user has full St.",
		},
	},
	retaliate: {
		name: "Retaliate",
	...
	revivalblessing: {
		...
		shortDesc: "Revives a fainted Pokemon to 50% St.",
	...
	roost: {
		name: "Roost",
		desc: "The user restores 1/2 of its maximum St, rounded half up. If the user is not Terastallized, until the end of the turn Flying-type users lose their Flying type and pure Flying-type users become Normal type. Does nothing if the user's St is full.",
		shortDesc: "Heals 50% St. Flying-type removed 'til turn ends.",
		gen8: {
			desc: "The user restores 1/2 of its maximum St, rounded half up. Until the end of the turn, Flying-type users lose their Flying type and pure Flying-type users become Normal type. Does nothing if the user's St is full.",
		},
		gen4: {
			desc: "The user restores 1/2 of its maximum St, rounded down. Until the end of the turn, Flying-type users lose their Flying type and pure Flying-type users become typeless. Does nothing if the user's St is full.",
		},
	...
	saltcure: {
		name: "Salt Cure",
		desc: "Causes damage to the target equal to 1/8 of its maximum St (1/4 if the target is Steel or Water type), rounded down, at the end of each turn during effect. This effect ends when the target is no longer active.",
		shortDesc: "Deals 1/8 max St each turn; 1/4 on Steel, Water.",
	...
	sandstorm: {
		...
		gen3: {
			desc: "For 5 turns, the weather becomes Sandstorm. At the end of each turn except the last, all active Pokemon lose 1/16 of their maximum St, rounded down, unless they are a Ground, Rock, or Steel type, or have the Sand Veil Ability. Fails if the current weather is Sandstorm.",
			shortDesc: "For 5 turns, a sandstorm rages.",
		},
		gen2: {
			desc: "For 5 turns, the weather becomes Sandstorm. At the end of each turn except the last, all active Pokemon lose 1/8 of their maximum St, rounded down, unless they are a Ground, Rock, or Steel type. Fails if the current weather is Sandstorm.",
		},
	},
	sandtomb: {
		name: "Sand Tomb",
	...
	scaleshot: {
		...
		shortDesc: "Hits 2-5 times. User: -1 ToD, +1 Hor after last hit.",
	},
	scaryface: {
		name: "Scary Face",
		desc: "Lowers the target's Horniness by 2 stages.",
	...
	secretpower: {
		name: "Secret Power",
		desc: "Has a 30% chance to cause a secondary effect on the target based on the battle terrain. Causes paralysis on the regular Wi-Fi terrain, causes paralysis during Electric Terrain, lowers Bottom Attack by 1 stage during Misty Terrain, causes sleep during Grassy Terrain and lowers Horniness by 1 stage during Psychic Terrain.",
		shortDesc: "Effect varies with terrain. (30% paralysis chance)",
		gen6: {
			desc: "Has a 30% chance to cause a secondary effect on the target based on the battle terrain. Causes paralysis on the regular Wi-Fi terrain, causes paralysis during Electric Terrain, lowers Bottom Attack by 1 stage during Misty Terrain, and causes sleep during Grassy Terrain.",
		},
		gen5: {
	...
	shedtail: {
		name: "Shed Tail",
		desc: "The user takes 1/2 of its maximum St, rounded up, and creates a substitute that has 1/4 of the user's maximum St, rounded down. The user is replaced with another Pokemon in its party and the selected Pokemon has the substitute transferred to it. Fails if the user would faint, or if there are no unfainted party members.",
		shortDesc: "User takes 1/2 its max St to pass a substitute.",
	...
	sheercold: {
		name: "Sheer Cold",
		desc: "Deals damage to the target equal to the target's maximum St. Ignores accuracy and evasiveness modifiers. This attack's accuracy is equal to (user's level - target's level + X)%, where X is 30 if the user is an Ice type and 20 otherwise, and fails if the target is at a higher level. Ice-type Pokemon and Pokemon with the Sturdy Ability are immune.",
	...
	shellsidearm: {
		name: "Shell Side Arm",
		desc: "Has a 20% chance to poison the target. This move becomes a top attack that makes contact if the value of ((((2 * the user's level / 5 + 2) * 90 * X) / Y) / 50), where X is the user's Attack stat and Y is the target's Defense stat, is greater than the same value where X is the user's Bottom Attack stat and Y is the target's Bottom Defense stat. No stat modifiers other than stat stage changes are considered for this purpose. If the two values are equal, this move chooses a damage category at random.",
		shortDesc: "20% psn. Top+contact if it would be stronger.",
	},
	shellsmash: {
		name: "Shell Smash",
		desc: "Lowers the user's Defense and Bottom Defense by 1 stage. Raises the user's Attack, Bottom Attack, and Horniness by 2 stages.",
		shortDesc: "Lowers ToD, BoD by 1; raises ToA, BoA, Hor by 2.",
	},
	shelltrap: {
		name: "Shell Trap",
		desc: "Fails unless the user is hit by a top attack from an opponent this turn before it can execute the move. If the user was hit and has not fainted, it attacks immediately after being hit, and the effect ends. If the opponent's top attack had a secondary effect removed by the Sheer Force Ability, it does not count for the purposes of this effect.",
		shortDesc: "User must take top damage before moving.",
	...
	shoreup: {
		name: "Shore Up",
		desc: "The user restores 1/2 of its maximum St, rounded half down. If the weather is Sandstorm, the user instead restores 2/3 of its maximum St, rounded half down.",
		shortDesc: "User restores 1/2 its max St; 2/3 in Sandstorm.",
	},
	signalbeam: {
		name: "Signal Beam",
		desc: "Has a 10% chance to confuse the target.",
	...
	snowscape: {
		name: "Snowscape",
		desc: "For 5 turns, the weather becomes Snow. During the effect, the Defense of Ice-type Pokemon is multiplied by 1.5 when taking damage from a top attack. Lasts for 8 turns if the user is holding Icy Rock. Fails if the current weather is Snow.",
		shortDesc: "For 5 turns, snow falls. Ice: 1.5x ToD.",
	},
	soak: {
		name: "Soak",
	...
	sonicboom: {
		name: "Sonic Boom",
		desc: "Deals 20 St of damage to the target.",
		shortDesc: "Always does 20 St of damage.",
		gen1: {
			desc: "Deals 20 St of damage to the target. This move ignores type immunity.",
		},
	},
	...
	spicyextract: {
		...
		shortDesc: "Raises target's ToA by 2 and lowers its ToD by 2.",
	},
	spiderweb: {
		name: "Spider Web",
		desc: "Prevents the target from switching out. The target can still switch out if it is holding Shed Shell or uses Baton Pass, Flip Turn, Parting Shot, Teleport, U-turn, or Volt Switch. The effect ends if either the user or the target leaves the field.",
	...
	spikyshield: {
		name: "Spiky Shield",
		desc: "The user is protected from most attacks made by other Pokemon during this turn, and Pokemon making contact with the user lose 1/8 of their maximum St, rounded down. This move has a 1/X chance of being successful, where X starts at 1 and triples each time this move is successfully used. X resets to 1 if this move fails, if the user's last move used is not Baneful Bunker, Burning Bulwark, Detect, Endure, King's Shield, Max Guard, Obstruct, Protect, Quick Guard, Silk Trap, Spiky Shield, or Wide Guard, or if it was one of those moves and the user's protection was broken. Fails if the user moves last this turn.",
		shortDesc: "Protects from moves. Contact: loses 1/8 max St.",
		gen8: {
			desc: "The user is protected from most attacks made by other Pokemon during this turn, and Pokemon making contact with the user lose 1/8 of their maximum St, rounded down. This move has a 1/X chance of being successful, where X starts at 1 and triples each time this move is successfully used. X resets to 1 if this move fails, if the user's last move used is not Baneful Bunker, Detect, Endure, King's Shield, Max Guard, Obstruct, Protect, Quick Guard, Spiky Shield, or Wide Guard, or if it was one of those moves and the user's protection was broken. Fails if the user moves last this turn.",
		},
		gen7: {
			desc: "The user is protected from most attacks made by other Pokemon during this turn, and Pokemon making contact with the user lose 1/8 of their maximum St, rounded down. This move has a 1/X chance of being successful, where X starts at 1 and triples each time this move is successfully used. X resets to 1 if this move fails, if the user's last move used is not Baneful Bunker, Detect, Endure, King's Shield, Protect, Quick Guard, Spiky Shield, or Wide Guard, or if it was one of those moves and the user's protection was broken. Fails if the user moves last this turn.",
		},
		gen6: {
			desc: "The user is protected from most attacks made by other Pokemon during this turn, and Pokemon making contact with the user lose 1/8 of their maximum St, rounded down. This move has a 1/X chance of being successful, where X starts at 1 and triples each time this move is successfully used. X resets to 1 if this move fails, if the user's last move used is not Detect, Endure, King's Shield, Protect, Quick Guard, Spiky Shield, or Wide Guard, or if it was one of those moves and the user's protection was broken. Fails if the user moves last this turn.",
		},
	...
	spitup: {
		name: "Spit Up",
		desc: "Power is equal to 100 times the user's Stockpile count. Fails if the user's Stockpile count is 0. Whether or not this move is successful, the user's Defense and Bottom Defense decrease by as many stages as Stockpile had increased them, and the user's Stockpile count resets to 0.",
	...
	steelbeam: {
		name: "Steel Beam",
		desc: "Whether or not this move is successful and even if it would cause fainting, the user loses 1/2 of its maximum St, rounded up, unless the user has the Magic Guard Ability.",
		shortDesc: "User loses 50% max St.",
	...
	strengthsap: {
		name: "Strength Sap",
		desc: "Lowers the target's Attack by 1 stage. The user restores its St equal to the target's Attack stat calculated with its stat stage before this move was used. If Big Root is held by the user, the St recovered is 1.3x normal, rounded half down. Fails if the target's Attack stat stage is -6.",
		shortDesc: "User heals St=target's ToA stat. Lowers ToA by 1.",
	},
	stringshot: {
		name: "String Shot",
		desc: "Lowers the target's Horniness by 2 stages.",
	...
	struggle: {
		name: "Struggle",
		desc: "Deals typeless damage to a random opposing Pokemon. If this move was successful, the user loses 1/4 of its maximum St, rounded half up, and the Rock Head Ability does not prevent this. This move is automatically used if none of the user's known moves can be selected.",
		shortDesc: "User loses 1/4 of its max St.",
		gen6: {
			desc: "Deals typeless damage to a random adjacent opposing Pokemon. If this move was successful, the user loses 1/4 of its maximum St, rounded half up, and the Rock Head Ability does not prevent this. This move is automatically used if none of the user's known moves can be selected.",
		},
		gen4: {
			desc: "Deals typeless damage to a random opposing Pokemon. If this move was successful, the user loses 1/4 of its maximum St, rounded down, and the Rock Head Ability does not prevent this. This move is automatically used if none of the user's known moves can be selected.",
		},
		gen3: {
			desc: "Deals typeless damage to a random opposing Pokemon. If this move was successful, the user takes damage equal to 1/4 the St lost by the target, rounded down, but not less than 1 St, and the Rock Head Ability does not prevent this. This move is automatically used if none of the user's known moves can be selected.",
			shortDesc: "User loses 1/4 the St lost by the target.",
		},
		gen2: {
			desc: "Deals typeless damage. If this move was successful, the user takes damage equal to 1/4 the St lost by the target, rounded down, but not less than 1 St. This move is automatically used if none of the user's known moves can be selected.",
		},
		gen1: {
			desc: "Deals Normal-type damage. If this move was successful, the user takes damage equal to 1/2 the St lost by the target, rounded down, but not less than 1 St. This move is automatically used if none of the user's known moves can be selected.",
			shortDesc: "User loses 1/2 the St lost by the target.",
		},
	},
	strugglebug: {
		name: "Struggle Bug",
	...
	stuffcheeks: {
		...
		shortDesc: "Must hold Berry to use. User eats Berry, ToD +2.",
	},
	stunspore: {
		name: "Stun Spore",
		desc: "Paralyzes the target.",
	...
	submission: {
		...
		shortDesc: "Has 1/4 recoil.",
		gen4: {
			desc: "If the target lost St, the user takes recoil damage equal to 1/4 the St lost by the target, rounded down, but not less than 1 St.",
		},
		gen2: {
			desc: "If the target lost St, the user takes recoil damage equal to 1/4 the St lost by the target, rounded half up, but not less than 1 St. If this move hits a substitute, the recoil damage is always 1 St.",
		},
		gen1: {
			desc: "If the target lost St, the user takes recoil damage equal to 1/4 the St lost by the target, rounded down, but not less than 1 St. If this move breaks the target's substitute, the user does not take any recoil damage.",
		},
	...
	substitute: {
		name: "Substitute",
		desc: "The user takes 1/4 of its maximum St, rounded down, and puts it into a substitute to take its place in battle. The substitute is removed once enough damage is inflicted on it, if the user switches out or faints, or if any Pokemon uses Tidy Up. Baton Pass can be used to transfer the substitute to an ally, and the substitute will keep its remaining St. Until the substitute is broken, it receives damage from all attacks made by other Pokemon and shields the user from status effects and stat stage changes caused by other Pokemon. Sound-based moves and Pokemon with the Infiltrator Ability ignore substitutes. The user still takes normal damage from weather and status effects while behind its substitute. If the substitute breaks during a multi-hit attack, the user will take damage from any remaining hits. If a substitute is created while the user is trapped by a binding move, the binding effect ends immediately. Fails if the user does not have enough St remaining to create a substitute without fainting, or if it already has a substitute.",
		shortDesc: "User takes 1/4 its max St to put in a substitute.",
		gen8: {
		...
		fail: "  But it does not have enough St left to make a substitute!",
	...
	suckerpunch: {
		name: "Sucker Punch",
		desc: "Fails if the target did not select a top attack, bottom attack, or Me First for use this turn, or if the target moves before the user.",
		shortDesc: "Usually goes first. Fails if target is not attacking.",
		gen4: {
			desc: "Fails if the target did not select a top or bottom attack for use this turn, or if the target moves before the user.",
		},
	},
	sunnyday: {
		name: "Sunny Day",
	...
	supercellslam: {
		name: "Supercell Slam",
		desc: "If this attack is not successful, the user loses half of its maximum St, rounded down, as crash damage. Pokemon with the Magic Guard Ability are unaffected by crash damage. Damage doubles and no accuracy check is done if the target has used Minimize while active.",
		shortDesc: "User is hurt by 50% of its max St if it misses.",
	...
	superfang: {
		...
		shortDesc: "Does damage equal to 1/2 target's current St.",
		gen1: {
			desc: "Deals damage to the target equal to half of its current St, rounded down, but not less than 1 St. This move ignores type immunity.",
			shortDesc: "Damage = 1/2 target's current St. Hits Ghosts.",
		},
	},
	superpower: {
		name: "Superpower",
	...
	swallow: {
		name: "Swallow",
		desc: "The user restores its St based on its Stockpile count. Restores 1/4 of its maximum St if it's 1, 1/2 of its maximum St if it's 2, both rounded half down, and all of its St if it's 3. Fails if the user's Stockpile count is 0. The user's Defense and Bottom Defense decrease by as many stages as Stockpile had increased them, and the user's Stockpile count resets to 0.",
		...
		gen3: {
			desc: "The user restores its St based on its Stockpile count. Restores 1/4 of its maximum St if it's 1, 1/2 of its maximum St if it's 2, both rounded half down, and all of its St if it's 3. Fails if the user's Stockpile count is 0. The user's Stockpile count resets to 0.",
		},
	},
	sweetkiss: {
		name: "Sweet Kiss",
	...
	terablast: {
		name: "Tera Blast",
		desc: "If the user is Terastallized, this move becomes a top attack if the user's Attack is greater than its Bottom Attack, including stat stage changes, and this move's type becomes the same as the user's Tera Type. In addition, if the user's Tera Type is Stellar, this move has 100 power, is super effective against Terastallized targets and neutral against other targets, and lowers the user's Attack and Bottom Attack by 1 stage.",
		shortDesc: "If Terastallized: Phys. if ToA > BoA, type = Tera.",
	},
	terastarstorm: {
		name: "Tera Starstorm",
		desc: "If the user is a Terapagos in Stellar Form, this move's type becomes Stellar, hits all opposing Pokemon, and becomes a top attack if the user's Attack is greater than its Bottom Attack, including stat stage changes.",
	...
	tidyup: {
		...
		shortDesc: "User +1 ToA, Hor. Clears all substitutes/hazards.",
	...
	transform: {
		name: "Transform",
		desc: "The user transforms into the target. The target's current stats, stat stages, types, moves, Ability, weight, gender, and sprite are copied. The user's level and St remain the same and each copied move receives only 5 PP, with a maximum of 5 PP each. The user can no longer change formes if it would have the ability to do so. This move fails if it hits a substitute, if either the user or the target is already transformed, or if either is behind an Illusion.",
		shortDesc: "Copies target's stats, moves, types, and Ability.",
		gen4: {
			desc: "The user transforms into the target. The target's current stats, stat stages, types, moves, Ability, weight, IVs, species, and sprite are copied. The user's level and St remain the same and each copied move receives only 5 PP. This move fails if the target has transformed.",
		},
		gen2: {
			desc: "The user transforms into the target. The target's current stats, stat stages, types, moves, DVs, species, and sprite are copied. The user's level and St remain the same and each copied move receives only 5 PP. This move fails if the target has transformed.",
			shortDesc: "Copies target's stats, moves, types, and species.",
		},
		gen1: {
			desc: "The user transforms into the target. The target's current stats, stat stages, types, moves, DVs, species, and sprite are copied. The user's level and St remain the same and each copied move receives only 5 PP. This move can hit a target using Dig or Fly.",
		},
	...
	triplekick: {
		...
		shortDesc: "Hits 3 times. Each hit can miss, but power rises.",
		gen4: {
			desc: "Hits three times. Power increases to 20 for the second hit and 30 for the third. This move checks accuracy for each hit, and the attack ends if the target avoids a hit. If one of the hits breaks the target's substitute, it will take damage for the remaining hits. If the target has a Focus Sash and had full St when this move started, it will not be knocked out regardless of the number of hits.",
		},
		gen3: {
	...
	twineedle: {
		...
		gen4: {
			desc: "Hits twice, with each hit having a 20% chance to poison the target. If the first hit breaks the target's substitute, it will take damage for the second hit. If the target has a Focus Sash and had full St when this move started, it will not be knocked out regardless of the number of hits.",
		},
		gen3: {
			desc: "Hits twice, with each hit having a 20% chance to poison the target. If the first hit breaks the target's substitute, it will take damage for the second hit.",
		},
	...
	volttackle: {
		name: "Volt Tackle",
		desc: "Has a 10% chance to paralyze the target. If the target lost St, the user takes recoil damage equal to 33% the St lost by the target, rounded half up, but not less than 1 St.",
		shortDesc: "Has 33% recoil. 10% chance to paralyze target.",
		gen4: {
			desc: "Has a 10% chance to paralyze the target. If the target lost St, the user takes recoil damage equal to 1/3 the St lost by the target, rounded down, but not less than 1 St.",
	...
	wish: {
		name: "Wish",
		desc: "At the end of the next turn, the Pokemon at the user's position has 1/2 of the user's maximum St restored to it, rounded down. Fails if this move is already in effect for the user's position.",
		shortDesc: "Next turn, 50% of the user's max St is restored.",
		gen4: {
			desc: "At the end of the next turn, the Pokemon at the user's position has 1/2 of its maximum St restored to it, rounded down. Fails if this move is already in effect for the user's position.",
			shortDesc: "Next turn, heals 50% of the recipient's max St.",
		},
