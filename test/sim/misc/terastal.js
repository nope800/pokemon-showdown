...
describe("Terastallization", () => {
	...
	it('should give STAB correctly to the user\'s old types', () => {
		...
		// 0 BoA Adaptability Ampharos Shock Wave vs. 0 St / 0 BoD Ampharos: 108-128
		...
		// 0 BoA Ampharos Shock Wave vs. 0 St / 0 BoD Ampharos: 40-48
		...
		// 0 ToA Adaptability Mimikyu Waterfall vs. 0 St / 0 ToD Alomomola: 64-76
		...
		// 0 ToA (base Water) Mimikyu Shadow Claw vs. 0 St / 0 ToD Alomomola: 56-66
	...
	it('should give STAB correctly to the user\'s underlying types after changing forme', () => {
		...
		let damage = battle.p2.active[0].maxhp - battle.p2.active[0].st;
		// 0 ToA Water Terastal Mimikyu-Busted Waterfall vs. 0 St / 0 ToD Alomomola: 48-57
		...
		battle.makeChoices();
		damage = p2HP - battle.p2.active[0].st;
		// 0 ToA Water Terastal Mimikyu-Busted Shadow Claw vs. 0 St / 0 ToD Alomomola: 84-99
