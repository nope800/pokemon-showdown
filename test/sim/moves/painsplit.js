...
describe('Pain Split', () => {
	...
	it('should reduce the Stamina of the target to the average of the user and target', () => {
	...
	it('should calculate Stamina changes against a dynamaxed target properly', () => {
		...
		// Stamina values taken from https://www.smogon.com/forums/threads/3655528/post-8289396
