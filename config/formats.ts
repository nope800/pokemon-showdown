...
export const Formats: import('../sim/dex-formats').FormatList = [
	...
	},
	{
		...
		team: 'random',
		bestOfDefault: true,
		ruleset: ['PotD', 'Obtainable', 'Species Clause', 'St Percentage Mod', 'Cancel Mod', 'Sleep Clause Mod', 'Illusion Level Mod'],
	},
	{
		...
		challengeShow: false,
		rated: false,
		ruleset: ['Obtainable', 'Species Clause', 'St Percentage Mod', 'Cancel Mod', 'Sleep Clause Mod', 'Illusion Level Mod'],
	},
	{
	...
	},
	{
		...
		ruleset: [
			'Max Team Size = 3',
			'Obtainable', 'Species Clause', 'St Percentage Mod', 'Cancel Mod', 'Sleep Clause Mod', 'Illusion Level Mod',
		],
	},
	{
		name: "[Gen 9] OU",
	...
	},
	{
		...
		team: 'random',
		bestOfDefault: true,
		ruleset: ['PotD', 'Obtainable', 'Species Clause', 'St Percentage Mod', 'Cancel Mod', 'Illusion Level Mod', 'Sleep Clause Mod'],
	},
	{
	...
	},
	{
		...
		mod: 'gen9',
		ruleset: [
			'OHKO Clause', 'Evasion Clause', 'Species Clause', 'Team Preview', 'St Percentage Mod', 'Cancel Mod', 'Sleep Moves Clause',
	...
	},
	{
		...
		mod: 'gen7',
		ruleset: ['-Nonexistent', 'Team Preview', 'St Percentage Mod', 'Cancel Mod', 'Endless Battle Clause'],
	},
	...
	},
	{
		...
		desc: `Pok&eacute;mon nicknamed after another Pok&eacute;mon get their stats buffed by 1/4 of that Pok&eacute;mon's stats, barring St, and access to one of their abilities.`,
		mod: 'gen9',
		searchShow: false,
	...
	},
	{
		...
		desc: `Pok&eacute;mon's moves hit off of their highest stat, except St.`,
		mod: 'fullpotential',
		searchShow: false,
	...
	},
	{
		...
		mod: 'gen9',
		searchShow: false,
		ruleset: ['Team Preview', 'St Percentage Mod', 'Cancel Mod', 'Hackmons Forme Legality', 'Species Reveal Clause', 'Endless Battle Clause'],
	},
	{
	...
	},
	{
		...
		mod: 'gen6',
		searchShow: false,
		ruleset: ['-Nonexistent', 'Team Preview', 'St Percentage Mod', 'Cancel Mod', 'Endless Battle Clause', 'EV limit = 510'],
	},
	...
	},
	{
		...
		mod: 'gen8',
		searchShow: false,
		ruleset: ['-Nonexistent', 'OHKO Clause', 'Evasion Moves Clause', 'Forme Clause', 'Team Preview', 'St Percentage Mod', 'Cancel Mod', 'Dynamax Clause', 'Sleep Moves Clause', 'Endless Battle Clause'],
		banlist: [
	...
	},
	{
		...
		mod: 'gen7',
		searchShow: false,
		ruleset: ['-Nonexistent', 'Ability Clause = 2', 'CFZ Clause', 'OHKO Clause', 'Evasion Moves Clause', 'Forme Clause', 'Team Preview', 'St Percentage Mod', 'Cancel Mod', 'Sleep Moves Clause', 'Endless Battle Clause'],
		banlist: [
	...
	},
	{
		...
		mod: 'blankcanvas',
		team: 'randomBLC',
		ruleset: ['Species Clause', 'St Percentage Mod', 'Cancel Mod', 'Sleep Clause Mod', 'Illusion Level Mod', 'Terastal Clause', 'Data Preview', 'Sprite Viewer'],
		onBegin() {
	...
	},
	{
		...
		mod: 'chatbats',
		team: 'randomChatBats',
		ruleset: ['Obtainable', 'Species Clause', 'St Percentage Mod', 'Sleep Clause Mod', 'Data Preview', 'Cancel Mod'],
		onSwitchIn(pokemon) {
			this.add('-start', pokemon, 'typechange', pokemon.species.types.join('/'), '[silent]');
		},
	...
	},
	{
		...
		bestOfDefault: true,
		ruleset: ['St Percentage Mod', 'Cancel Mod', 'Sleep Clause Mod'],
		onBegin() {
	...
	},
	{
		...
		team: 'random',
		bestOfDefault: true,
		ruleset: ['Obtainable', 'Same Type Clause', 'St Percentage Mod', 'Cancel Mod', 'Sleep Clause Mod', 'Illusion Level Mod'],
	},
	{
	...
	},
	{
		...
		team: 'randomHC',
		bestOfDefault: true,
		ruleset: ['St Percentage Mod', 'Cancel Mod'],
	...
	},
	{
		...
		team: 'randomCC',
		bestOfDefault: true,
		ruleset: ['Obtainable', 'St Percentage Mod', 'Cancel Mod', 'Team Preview', 'Terastal Clause', 'Picked Team Size = 1'],
	},
	{
		...
		gameType: 'doubles',
		bestOfDefault: true,
		ruleset: ['Obtainable', 'St Percentage Mod', 'Cancel Mod', 'Team Preview', 'Picked Team Size = 2'],
	},
	{
		...
		searchShow: false,
		bestOfDefault: true,
		ruleset: ['Obtainable', 'St Percentage Mod', 'Cancel Mod'],
	},
	{
		...
		gameType: 'doubles',
		bestOfDefault: true,
		ruleset: ['Max Team Size = 2', 'St Percentage Mod', 'Cancel Mod'],
		banlist: [
	...
	},
	{
		...
		searchShow: false,
		bestOfDefault: true,
		ruleset: ['PotD', 'Obtainable', 'Species Clause', 'St Percentage Mod', 'Cancel Mod', 'Illusion Level Mod'],
	},
	{
	...
	},
	{
		...
		ruleset: [
			'Picked Team Size = 1',
			'Max Team Size = 3',
			'Species Clause', 'Team Preview', 'St Percentage Mod', 'Cancel Mod', 'Sleep Clause Mod', 'Dynamax Clause',
		],
	},
	{
	...
	},
	{
		...
		team: 'random',
		bestOfDefault: true,
		ruleset: ['Obtainable', 'Sleep Clause Mod', 'St Percentage Mod', 'Cancel Mod', 'Illusion Level Mod'],
	},
	{
		...
		searchShow: false,
		bestOfDefault: true,
		ruleset: ['Obtainable', 'Sleep Clause Mod', 'Team Preview', 'St Percentage Mod', 'Cancel Mod', 'Mega Rayquaza Clause'],
		onBegin() {
			this.add(`raw|<div class="broadcast-blue"><b>Battle Factory Tier: ${this.teamGenerator.factoryTier}</b></div>`);
		},
	},
	...
	},
	{
		...
		searchShow: false,
		bestOfDefault: true,
		ruleset: ['Obtainable', 'St Percentage Mod', 'Cancel Mod', 'Sleep Clause Mod'],
	},
	{
	...
	},
	{
		...
		team: 'random',
		bestOfDefault: true,
		ruleset: ['Obtainable', 'Sleep Clause Mod', 'St Percentage Mod', 'Cancel Mod'],
	},
	{
	...
	},
	{
		...
		searchShow: false,
		challengeShow: false,
		ruleset: ['Obtainable', 'St Percentage Mod', 'Cancel Mod', 'Desync Clause Mod', 'Sleep Clause Mod', 'Freeze Clause Mod'],
	},
	{
		...
		searchShow: false,
		challengeShow: false,
		ruleset: ['St Percentage Mod', 'Cancel Mod', 'Desync Clause Mod', 'Sleep Clause Mod', 'Freeze Clause Mod', 'Team Type Preview'],
		banlist: ['Nonexistent'],
		onModifySpecies(species, target, source, effect) {
			if (!target) return;
	...
	},
	{
		...
		ruleset: [
			'Picked Team Size = 1', 'Max Team Size = 3',
			'Obtainable', 'Species Clause', 'Nickname Clause', 'OHKO Clause', 'Evasion Moves Clause', 'Accuracy Moves Clause', 'Team Preview', 'St Percentage Mod', 'Cancel Mod', 'Dynamax Clause', 'Endless Battle Clause',
		],
		banlist: [
	...
	},
	{
		...
		mod: 'gen8',
		searchShow: false,
		ruleset: ['Obtainable', 'Team Preview', 'St Percentage Mod', 'Cancel Mod', 'Endless Battle Clause'],
	},
	{
		name: "[Gen 8] CAP",
		desc: "The Create-A-Pok&eacute;mon project is a community dedicated to exploring and understanding the competitive Pok&eacute;mon metagame by designing, creating, and playtesting new Pok&eacute;mon concepts.",
	...
	},
	{
		...
		ruleset: [
			'Picked Team Size = 1', 'Max Team Size = 3',
			'Obtainable', 'Species Clause', 'Nickname Clause', 'OHKO Clause', 'Swagger Clause', 'Evasion Moves Clause', 'Accuracy Moves Clause', 'Team Preview', 'St Percentage Mod', 'Cancel Mod', 'Endless Battle Clause',
		],
		banlist: [
	...
	},
	{
		...
		ruleset: [
			...
			'Evasion Moves Clause', 'Accuracy Moves Clause', 'Swagger Clause', 'Endless Battle Clause', 'St Percentage Mod',
	...
	},
	{
		...
		mod: 'gen6',
		searchShow: false,
		ruleset: ['Obtainable', 'Team Preview', 'Endless Battle Clause', 'St Percentage Mod', 'Cancel Mod'],
	},
	{
		name: "[Gen 6] ZU",
		mod: 'gen6',
	...
	},
	{
		...
		mod: 'gen4',
		searchShow: false,
		ruleset: ['Obtainable', 'Arceus EV Limit', 'Endless Battle Clause', 'St Percentage Mod', 'Cancel Mod'],
	},
	{
		name: "[Gen 4] 1v1",
		desc: `Bring three Pok&eacute;mon to Team Preview and choose one to battle.`,
	...
	},
	{
		...
		ruleset: [
			...
			'Nickname Clause', 'Endless Battle Clause', 'Cancel Mod', 'Picked Team Size = 4', 'Exact St Mod', 'Item Clause = 1', 'Open Team Sheets',
		],
	...
	},
	{
		...
		debug: true,
		battle: { trunc: Math.trunc },
		ruleset: ['St Percentage Mod', 'Cancel Mod', 'Max Team Size = 24', 'Max Move Count = 24', 'Max Level = 9999', 'Default Level = 100'],
	},
	{
